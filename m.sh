...
rm $ANDROID_TOP/device/mediatek/g750_t01/proprietary-files.txt &>/dev/null
echo "####################################################################################"
...
include vendor/mediatek/g750_t01/g750_t01-vendor-blobs.mk

EOF
echo "####################################################################################"
echo -e "#\t\t\t\tvendor-blobs.mk\t\t\t\t\t\t#"
echo "####################################################################################"
cat << EOF >> g750_t01-vendor-blobs.mk
# Copyright (C) 2014 The Android Open Source Project
# Create by Seifer Cross <roliya@163.com>
# 09/18/2014 - 04:28:34 CTS
#
...
echo -e "\tvendor/mediatek/g750_t01/$LST:system/$TAT \\" >> g750_t01-vendor-blobs.mk
echo "$TAT" >> $ANDROID_TOP/device/mediatek/g750_t01/proprietary-files.txt
if [ $OVER == "1" ]; then
echo -e "\t\t$MOD \\" >> AndroidP.mk
fi
done

echo -e "\ninclude \$(BUILD_PREBUILT)" >> g750_t01-vendor-blobs.mk
